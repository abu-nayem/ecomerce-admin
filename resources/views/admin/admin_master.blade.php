    ...
    <div class="page-main-header">
        <div class="main-header-right row">
            <div class="main-header-left d-lg-none">
                <div class="logo-wrapper"><a href="{{url('/admin')}}"><img class="blur-up lazyloaded" src="{{asset('public/admin/assets/images/dashboard/multikart-logo.png')}}" alt=""></a></div>
            </div>
                    ...
                    <li class="onhover-dropdown">
                        ...
                        <ul class="profile-dropdown onhover-show-div p-20 profile-dropdown-hover">
                          ...
                          <!--   <li><a href="#"><i data-feather="lock"></i>Lock Screen</a></li> -->
                            <li><a href="{{route('admin.newuser')}}"><i data-feather="settings"></i>Settings</a></li>
                ...
                <ul class="sidebar-menu">
                    ...
                    <li id="product"><a class="sidebar-header" href="#"><i data-feather="box"></i> <span>Products</span><i class="fa fa-angle-right pull-right" aria-hidden="true"></i></a>
                        <ul class="sidebar-submenu">
                                    ...
                                    <li id="variable"><a href="{{route('admin.variable')}}"><i class="fa fa-circle"></i>New Variable</a></li>
                    ...
                    <li><a class="sidebar-header" id="stock" href="{{route('admin.stocklist')}}"><i data-feather="dollar-sign"></i><span>Stock Product</span></a>
                        <li id="order"><a class="sidebar-header" href="#"><i data-feather="box"></i> <span>Orders</span><i class="fa fa-angle-right pull-right" aria-hidden="true"></i></a>
                        <ul class="sidebar-submenu">
                            
                               
                                    <li id="pending_order"><a href="{{route('admin.order.orderReqquest')}}"><i class="fa fa-circle"></i>Pending Order</a></li>
                                    <li id="processing_order"><a href=""><i class="fa fa-circle"></i>Processing Order</a></li>
                                     <li id="delivered_order"><a href="{{route('admin.order.deliverd')}}"><i class="fa fa-circle"></i>Delivered Order</a></li>
                                    <li id="return_order"><a href="{{route('admin.productlist')}}"><i class="fa fa-circle"></i>Return Orders</a></li>
                                    <li id="return_order_product"><a href="{{route('admin.productlist')}}"><i class="fa fa-circle"></i>Return OrderProduct</a></li>
                                    <!-- <li><a href="product-detail.html"><i class="fa fa-circle"></i>Product Detail</a></li> -->
                    ...
                    <li id="setting"><a class="sidebar-header" href="" ><i data-feather="settings" ></i><span>Settings</span><i class="fa fa-angle-right pull-right"></i></a>
                        <ul class="sidebar-submenu">
                            <li> <a href="{{route('admin.setting')}}" id="update_setting"><i class="fa fa-circle"></i>Set Up</a></li>
                            <li>   <a href="{{route('admin.setting.slider')}}" id="slider"><i class="fa fa-circle"></i>Slider</a> </li>
                            <li>   <a href="{{route('admin.setting.banner')}}" id="banner"><i class="fa fa-circle"></i>Banner</a> </li>
                            <li><a href="profile.html"><i class="fa fa-circle"></i>About us</a></li>
                            <li><a href=""><i class="fa fa-circle"></i>Contact us</a></li>
                            

                        </ul>
                    </li>
                    <li id="basic"><a class="sidebar-header" href="" ><i data-feather="settings" ></i><span>Basic</span><i class="fa fa-angle-right pull-right"></i></a>
                        <ul class="sidebar-submenu">

                            <li> <a href="{{route('admin.privacy.terms')}}" id="privacy"><i class="fa fa-circle"></i>Privacy and terms</a></li>
                            <li> <a href="{{route('admin.faq.new')}}" id="faq-new"><i class="fa fa-circle"></i> New Faq</a></li>
                            <li> <a href="{{route('admin.faq')}}" id="faq"><i class="fa fa-circle"></i>Manage Faq</a></li>
