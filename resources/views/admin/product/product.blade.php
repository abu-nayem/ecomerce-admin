                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="digital-add needs-validation">
                                    ...
                                    <div class="form-group">
                                      <label>Have Size and Color?</label>
                                        <input type="checkbox" name="varibale" id="checkSizeColor" onclick="sizeColor()"/>
                                    </div>
                                    <div id="hideSlow" class="hideSlow" style="display:none">
                                   
                                       <div class="form-group">
                                        @foreach($colors as $color)
                                        <input type="checkbox" id="checkSizeColor{{$color->id}}" value="{{$color->id}}" name="color_id" >
                                        <label for="discount" class="col-form-label">{{$color->color}}</label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="checkbox" id="checkSizeColor{{$size->id}}" value="{{$size->id}}" name="size_id" >
                                        <label for="discount" class="col-form-label">{{$size->size}}</label>
...
function sizeColor() {
  var checkBox = document.getElementById("checkSizeColor");
  var text = document.getElementById("hideSlow");
  if (checkBox.checked == true){
    text.style.display = "block";
  } else {
     text.style.display = "none";
