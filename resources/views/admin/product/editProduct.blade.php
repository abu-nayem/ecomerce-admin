                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="digital-add needs-validation">
                                    ...
                                    <div id="hideSlow" class="hideSlow" >
                                   
                                       <div class="form-group">
                                        @foreach($colors as $color)
                                        <input type="checkbox" id="checkSizeColor{{$color->id}}" <?php foreach ($variable as $data) {
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="checkbox" id="checkSizeColor{{$size->id}}"<?php foreach ($variable as $data) {
                                          if($data->size_id==$size->id){
                                            echo "checked";
                                          }
                                        } ?>  value="{{$size->id}}" name="size_id" >
